...
const energyRatingEnum = z.enum(["A", "B", "C", "D", "E", "F", "G", "EN_TRAMITE", "EXENTO"]);
...
const propertyInput = z.object({
  ...
  usableAreaM2: z.number().int().optional().nullable(),
  floor: z.number().int().optional().nullable(),
  hasElevator: z.boolean().optional().nullable(),
  energyRating: energyRatingEnum.optional().nullable(),
  energyConsumptionValue: z.number().optional().nullable(),
  energyEmissionsRating: energyRatingEnum.optional().nullable(),
  energyEmissionsValue: z.number().optional().nullable(),
  condition: z.enum(["NUEVO", "BUEN_ESTADO", "A_REFORMAR", "REFORMADO"]).optional().nullable(),
  yearBuilt: z.number().int().optional().nullable(),
  parkingSpaces: z.number().int().optional().nullable(),
  heating: z.enum(["NINGUNA", "INDIVIDUAL", "CENTRAL"]).optional().nullable(),
  hasAirConditioning: z.boolean().optional().nullable(),
  hasTerrace: z.boolean().optional().nullable(),
  hasBalcony: z.boolean().optional().nullable(),
  hasGarden: z.boolean().optional().nullable(),
  hasPool: z.boolean().optional().nullable(),
  hasStorageRoom: z.boolean().optional().nullable(),
  isFurnished: z.boolean().optional().nullable(),
  isExterior: z.boolean().optional().nullable(),
  hoaFees: z.number().int().optional().nullable(),
